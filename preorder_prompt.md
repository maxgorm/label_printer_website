...
- states that **shipping is expected to begin in Fall 2026**
...
- Shipping messaging must say: **“Expected to begin shipping in Fall 2026”**
...
### Microcopy under CTA
**Pre-order now. Expected to begin shipping in Fall 2026.**
...
### Copy
This product is currently available for pre-order. By placing an order, you understand that Sentimo is in pre-production and is expected to begin shipping in Fall 2026.
...
**I understand that this is a pre-order, that shipping is expected to begin in Fall 2026, and that I will be refunded if Sentimo is unable to fulfill my order.**
...
### Pre-order note
This is a pre-order. Shipping is expected to begin in Fall 2026. If we are unable to fulfill your order, you will receive a full refund.
...
We currently expect shipping to begin in Fall 2026.
...
We currently expect Sentimo pre-orders to begin shipping in Fall 2026. This is our estimated timeline, not a guaranteed delivery date.
...
Your pre-order has been received and confirmed. Sentimo is expected to begin shipping in Fall 2026.
